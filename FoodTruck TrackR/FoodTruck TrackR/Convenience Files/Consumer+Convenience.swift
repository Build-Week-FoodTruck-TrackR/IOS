...
extension Consumer {
    convenience init(username: String, password: String, email: String, favoriteTrucks: [Truck], identifier: UUID = UUID(), context: NSManagedObjectContext = CoreDataStack.shared.mainContext) {
